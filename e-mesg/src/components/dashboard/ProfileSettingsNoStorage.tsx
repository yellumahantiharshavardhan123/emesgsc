...
import { User, Mail, Save, Edit3, Upload } from 'lucide-react';

export const ProfileSettingsNoStorage: React.FC = () => {
    ...
    <div className="p-4 space-y-6 max-h-full overflow-y-auto">
      ...
      <Card>
        ...
        <CardContent className="text-center">
          <Avatar className="h-24 w-24 mx-auto mb-4">
            <AvatarImage src={userProfile.photoURL || currentUser.photoURL || undefined} />
          ...
          <div className="flex items-center justify-center space-x-2 text-sm text-gray-500">
            ...
            <span>Photo uploads require Firebase Storage</span>
          </div>
          <p className="text-xs text-gray-400 mt-2">
            <span>Using {currentUser.photoURL ? 'Google' : 'default'} profile photo</span>
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="text-sm text-gray-600">
          ...
          <p className="mb-2">Version 1.0.0 - Built with React and Firebase</p>
          <div className="mt-4 p-3 bg-blue-50 rounded-lg">
            <p className="text-xs text-blue-700">
              💡 <strong>Note:</strong> Photo uploads are disabled in this version. 
              Enable Firebase Storage to upload custom profile photos and status images.
            </p>
          </div>
        </CardContent>
      </Card>
